...
class TestArsipValidationFinal extends Command
{
    protected $signature = 'test:arsip-validation-final';
    protected $description = 'Test arsip perencanaan validation final';
    ...
    public function handle()
    {
        ...
        $this->info("Testing validation final for arsip ID: {$arsip->id}");
