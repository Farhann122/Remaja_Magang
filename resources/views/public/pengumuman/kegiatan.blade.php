...
@section('title', 'Ketentuan Kegiatan | SIPARLEMEN')
...
@section('content')
  ...
  <section class="ketentuan-header d-flex align-items-center justify-content-center text-center text-white">
    ...
    <div class="content">
      <h1 class="fw-bold">Surat Pemberitahuan</h1>
  ...
  <section class="ketentuan-content py-5">
    <div class="container">
      <div class="card shadow-lg border-0 p-4 p-md-5">
        <h3 class="fw-bold mb-4 text-center">Surat Pemberitahuan Kegiatan Parlemen Remaja</h3>
...
<div class="pdf-viewer text-center my-4">
  <iframe 
    src="{{ asset('pdf/pemberitahuankegiatan.pdf') }}" 
