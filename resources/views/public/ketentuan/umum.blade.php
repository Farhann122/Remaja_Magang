...
@section('title', 'Ketentuan Umum | SIPARLEMEN')
...
@section('content')
  ...
  <section class="ketentuan-header d-flex align-items-center justify-content-center text-center text-white">
    ...
    <div class="content">
      <h1 class="fw-bold">Ketentuan Umum</h1>
  ...
  <section class="ketentuan-content py-5">
    <div class="container">
      <div class="card shadow-lg border-0 p-4 p-md-5">
        <h3 class="fw-bold mb-4 text-center">Ketentuan Umum Parlemen Remaja</h3>
        ...
        <div class="text-center my-4">
          <img src="{{ asset('image/umum1.jpg') }}" alt="Poster Parlemen Remaja" class="img-fluid rounded shadow poster-img">
        </div>
        <div class="text-center my-4">
          <img src="{{ asset('image/umum2.jpg') }}" alt="Poster Parlemen Remaja" class="img-fluid rounded shadow poster-img">
        </div>
