        ...
        <div class="col-6 col-xl-3">
            <div class="card card-one">
                <div class="card-body">
                    ...
                    <small><span class="d-inline-flex text-success">2.1% <i class="ri-arrow-up-line"></i></span> than last
                        week</small>
                </div><!-- card-body -->
            </div><!-- card-one -->
        </div><!-- col -->
        <div class="col-6 col-xl-3">
            <div class="card card-one">
                <div class="card-body">
                    ...
                    <small><span class="d-inline-flex text-danger">0.3% <i class="ri-arrow-down-line"></i></span> than last
                        week</small>
                </div><!-- card-body -->
            </div><!-- card-one -->
        </div><!-- col -->
        <div class="col-6 col-xl-3">
            <div class="card card-one">
                <div class="card-body">
                    ...
                    <small><span class="d-inline-flex text-success">1.2% <i class="ri-arrow-up-line"></i></span> than last
                        week</small>
                </div><!-- card-body -->
            </div><!-- card-one -->
        </div><!-- col -->
                    ...
                    <div class="p-2">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <p class="mb-0 fs-xs text-secondary">Measure how fast you’re growing monthly recurring
                                    revenue.</p>
                            </div><!-- col -->
                            <div class="col-sm-6">
                                ...
                                <p class="mb-0 fs-xs text-secondary">The revenue generated per account on a monthly or
                                    yearly basis.</p>
                            </div><!-- col -->
                        </div><!-- row -->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="card p-3 d-flex flex-row mb-2">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="fs-xs text-secondary mb-0 lh-4">Customers who have upgraded the level of your
                    ...
                    <div class="card p-3 d-flex flex-row">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="fs-xs text-secondary mb-0 lh-4">Customers who have ended their subscription with you.
                            </p>
                        </div>
                    </div>
                </div><!-- card-body -->
                ...
                <div class="card-body p-0">
                    <ul class="people-group">
                        <li class="people-item">
                            <div class="avatar"><img src="{{ asset('template/dist/assets/img/img6.jpg') }}"
                                    alt=""></div>
                        ...
                        <li class="people-item">
                            <div class="avatar"><img src="{{ asset('template/dist/assets/img/img7.jpg') }}"
                                    alt=""></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><img src="{{ asset('template/dist/assets/img/img8.jpg') }}"
                                    alt=""></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><img src="{{ asset('template/dist/assets/img/img9.jpg') }}"
                                    alt=""></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><img src="{{ asset('template/dist/assets/img/img10.jpg') }}"
                                    alt=""></div>
                            <div class="people-body">
            ...
            <div class="card card-one">
                ...
                <div class="card-body p-0">
                    <ul class="people-group">
                        ...
                        <li class="people-item">
                            <div class="avatar"><span class="avatar-initial bg-info fs-20"><i
                                        class="ri-coins-line"></i></span></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><span class="avatar-initial bg-primary fs-20"><i
                                        class="ri-truck-line"></i></span></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><span class="avatar-initial bg-pink fs-20"><i
                                        class="ri-truck-line"></i></span></div>
                            <div class="people-body">
                        ...
                        <li class="people-item">
                            <div class="avatar"><span class="avatar-initial bg-secondary fs-20"><i
                                        class="ri-secure-payment-line"></i></span></div>
                            <div class="people-body">
        ...
        <div class="col-xl-7">
            <div class="card card-one">
                ...
                <div class="card-body p-3 p-xl-4">
                    ...
                    <p class="fs-sm text-secondary mb-0">Open it in a spreadsheet and perform your own calculations,
