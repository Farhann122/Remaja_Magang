...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <h4 class="main-title mb-0">Edit Asal/Tujuan Surat</h4>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <div class="mb-3">
            <form action="{{ route('admin.asal_surat.update', $asalSurat->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4 d-flex align-items-start gap-2">
                    ...
                    <div class="d-flex flex-row gap-2">
                        <input required type="text" class="form-control" id="asal_surat" name="asal_surat"
                            placeholder="Masukan Asal/Tujuan Surat" value="{{ $asalSurat->asal_surat }}" style="width: 500px;">
