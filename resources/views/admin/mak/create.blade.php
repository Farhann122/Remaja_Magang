...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Tambah MAK</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('admin.mak.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <div class="mb-3 d-flex align-items-start gap-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <input required type="text" class="form-control" id="kode_mak" name="kode_mak"
                                placeholder="Masukan Kode MAK" value="" maxlength="6" style="width: 500px;">
                    ...
                    <div class="mb-3 d-flex align-items-start gap-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <textarea required class="form-control" id="nama_mak" name="nama_mak" rows="4"
                                placeholder="Masukan Nama MAK" style="width: 500px;"></textarea>
                            <font style="color: red; display: flex; align-items: center; padding: 0;">*</font>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-flex align-items-start gap-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <textarea required class="form-control" id="keterangan_mak" name="keterangan_mak" rows="4"
                                placeholder="Masukan Keterangan MAK" style="width: 500px;"></textarea>
                            <font style="color: red; display: flex; align-items: center; padding: 0;">*</font>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 d-flex align-items-start gap-3">
                        ...
                        <div class="d-flex flex-row gap-2">
                            <textarea required class="form-control" id="contoh_mak" name="contoh_mak" rows="4"
                                placeholder="Masukan Contoh MAK" style="width: 500px;"></textarea>
                            <font style="color: red; display: flex; align-items: center; padding: 0;">*</font>
                        </div>
                    </div>
