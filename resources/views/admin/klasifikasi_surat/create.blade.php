...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <h4 class="main-title mb-0">Tambah Klasifikasi Surat</h4>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <div class="mb-3">
            <form action="{{ route('admin.klasifikasi_surat.store') }}" method="POST">
                @csrf
                @method('POST')
                ...
                <div class="mb-4 d-flex align-items-start gap-2">
                    ...
                    <div class="d-flex flex-row gap-2">
                        <input required type="text" class="form-control" id="klasifikasi_surat" name="klasifikasi_surat"
                            placeholder="Masukan Klasifikasi Surat" value="" style="width: 500px;">
