            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Kode Surat</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.kode_surat.update', $kodeSurat->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4 d-flex align-items-start gap-1">
                                    ...
                                    <div class="d-flex flex-row gap-2">
                                        <input required type="text" class="form-control" id="kode_surat" name="kode_surat"
                                            placeholder="Masukan Kode Surat" value="{{ old('kode_surat', $kodeSurat->kode_surat) }}" style="width: 300px;">
                                ...
                                <div class="mb-4 d-flex align-items-start gap-1">
                                    ...
                                    <div class="d-flex flex-row gap-2">
                                        <input required type="text" class="form-control" id="keterangan" name="keterangan"
                                            placeholder="Masukan Keterangan" value="{{ old('keterangan', $kodeSurat->keterangan) }}" style="width: 300px;">
                                        <font style="color: red; display: flex; align-items: center; padding: 0;">*</font>
                                    </div>
                                </div>
