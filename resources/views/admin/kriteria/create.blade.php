        ...
        <form action="{{ route('admin.kriteria.store') }}" method="POST">
            ...
            <div class="mb-4 d-flex align-items-start gap-2">
                ...
                <div class="d-flex flex-row gap-2">
                    <input type="text" required class="form-control" id="kriteria" name="kriteria" placeholder="Masukkan Nama Kriteria" style="width:400px;">
            ...
            <div class="mb-4 d-flex align-items-start gap-2">
                ...
                <div class="d-flex flex-row gap-2">
                    <input type="number" required class="form-control" id="bobot" name="bobot" placeholder="Masukkan Bobot (0 - 100)" style="width:200px;">
                    <font style="color:red;">*</font>
                </div>
            </div>
