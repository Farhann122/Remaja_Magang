    ...
    <div class="card-body">
        <form action="{{ route('admin.skoring.store') }}" method="POST">
            ...
            <div class="mb-4 d-flex align-items-start gap-2">
                ...
                <div class="d-flex flex-row gap-2">
                    <input required type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi" style="width:500px;">
                    <font style="color:red;">*</font>
                </div>
            </div>
            ...
            <div class="mb-4 d-flex align-items-start gap-2">
                ...
                <div class="d-flex flex-row gap-2">
                    <input required type="number" class="form-control" id="bobot" name="bobot" placeholder="Masukkan Bobot" style="width:500px;">
                    <font style="color:red;">*</font>
                </div>
            </div>
